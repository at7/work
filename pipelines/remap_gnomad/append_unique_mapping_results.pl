...
my $dir = '/nfs/production/panda/ensembl/variation/data/gnomAD/v2.1/grch37/exomes/';

my $fh = FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_96/human/remap_gnomad/exomes/unique_mappings/chrom$chrom.txt", 'r');

my $fh_results =  FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_96/human/remap_gnomad/exomes/unique_mappings/$chrom.vcf", 'w');
...
sub get_37_vcf_entry {
  ...
  my $vcf_file = "$dir/gnomad.exomes.r2.1.sites.chr$chrom\_noVEP.vcf.gz";
