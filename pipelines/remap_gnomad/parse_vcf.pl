...
my $dir = '/hps/nobackup2/production/ensembl/anja/gnomad/Exomes/mapping_results/';
my $fh = FileHandle->new("$dir/correct_alternative_chr$chrom.txt", 'w');
my $vcf_file = "$dir/gnomad.exomes.r2.1.sites.grch38.chr$chrom\_noVEP.vcf.gz";
...
#  my $grch38_sequence = $fasta_db->seq("$sequence_id:$start,$end");
