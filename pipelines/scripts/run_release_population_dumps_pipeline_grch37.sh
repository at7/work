...
BASE_DIR=${HOME}/bin
DUMP_DIR=/hps/nobackup2/production/ensembl/anja/release_94/human/grch37/dumps/population/
init_pipeline.pl Bio::EnsEMBL::Variation::Pipeline::ReleaseDataDumps::PopulationDumps_conf \
    ...
    -hive_force_init 1 \
    -prefetched_frequencies /hps/nobackup2/production/ensembl/anja/release_94/human/grch37/dumps/allele_frequencies/  \
