password=$1
dir=/hps/nobackup/production/ensembl/anja/release_91/mouse/phenotype_data/
...
--dbname mus_musculus_variation_91_38 \
--user ensadmin \
--port 4521 \
--pass $password \
--cdbname mus_musculus_core_91_38 \
...
--working_dir ${dir} \
--source $data_source \
--ontology_dbname ensembl_ontology_91 \
