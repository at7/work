password=$1
dir=/hps/nobackup/production/ensembl/anja/release_92/mouse/phenotype_data/
...
--dbname mus_musculus_variation_92_38 \
--user ensadmin \
--port 4521 \
--pass $password \
--cdbname mus_musculus_core_92_38 \
...
--working_dir ${dir} \
--source $data_source \
--ontology_dbname ensembl_ontology_92 \
