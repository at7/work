password=$1
dir=/hps/nobackup2/production/ensembl/anja/release_95/mouse/phenotype_data/
...
--dbname mus_musculus_variation_95_38 \
--user ensadmin \
--port 4521 \
--pass $password \
--cdbname mus_musculus_core_95_38 \
--chost mysql-ens-var-prod-2.ebi.ac.uk \
--cuser ensro \
--cpass '' \
--cport 4521 \
...
--working_dir ${dir} \
--source $data_source \
--ontology_dbname ensembl_ontology_95 \
