...
-registry /hps/nobackup2/production/ensembl/anja/release_93/vep_dumps/ensembl.registry \
-pipeline_name dump_vep_human_${ENS_VERSION} \
-pipeline_dir /hps/nobackup2/production/ensembl/anja/release_93/vep_dumps/ \
