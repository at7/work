...
-registry /hps/nobackup2/production/ensembl/anja/release_96/human/vep_dumps/ensembl.registry \
-pipeline_name dump_vep_human_${ENS_VERSION} \
-pipeline_dir /hps/nobackup2/production/ensembl/anja/release_96/human/vep_dumps/ \
