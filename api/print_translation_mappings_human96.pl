...
$registry->load_all('/hps/nobackup2/production/ensembl/anja/release_96/human/ensembl.registry');

my $fh = FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_96/human/translation_md5s", 'w');
