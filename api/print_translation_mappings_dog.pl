...
$registry->load_all('/hps/nobackup2/production/ensembl/anja/release_98/dog/ensembl.registry');

my $fh = FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_98/dog/translation_md5s", 'w');

my @transcripts = ();
my $sa = $registry->get_adaptor('dog', 'core', 'slice');
my $include_lrg = 1;
