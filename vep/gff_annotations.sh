...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $woring_dir/vep_data/gff_annotation.out -e $working_dir/vep_data/gff_annotation.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/rachel_43_no_id_sorted.vcf  \
-o $working_dir/vep_data/output/gff_annotation_2018_01_18.txt \
--port 3337 \
--cache \
