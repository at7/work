...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/vep_data/paralogue_anno_init.out -e $working_dir/vep_data/paralogue_anno_init.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/grch38/homo_sapiens_clinically_associated.vcf \
-o $working_dir/vep_data/output/paralogue_anno_init.txt \
--database \
