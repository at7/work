...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/vep_data/dbnsfp_3.5a_grch38_MT.out -e $working_dir/vep_data/dbnsfp_3.5a_grch38_MT.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/grch38/MT.txt \
-o $working_dir/vep_data/output/MT.txt \
--cache \
--dir_cache /hps/nobackup2/production/ensembl/anja/vep/ \
--cache_version 92 \
--dir_plugins /homes/anja/bin/VEP_plugins/ \
--plugin dbNSFP,/nfs/production/panda/ensembl/variation/data/dbNSFP/3.5a/dbNSFP3.5a.txt.gz,ALL \
--force_overwrite \
...
#--plugin dbNSFP,/nfs/production/panda/ensembl/variation/data/dbNSFP/3.5a/dbNSFP3.5a.txt.gz,LRT_pred,MutationTaster_pred,MutationAssessor_pred,FATHMM_pred \
