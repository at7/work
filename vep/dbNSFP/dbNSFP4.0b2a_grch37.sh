...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/vep_data/dbNSFP4.0b2a_grch37.out -e $working_dir/vep_data/dbNSFP4.0b2a_grch37.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/grch37/4.0b1a_grch37.vcf  \
-o $working_dir/vep_data/output/4.0b2a_grch37.out \
--DB_VERSION 96 \
--port 3337 \
--cache \
--dir_cache /nfs/production/panda/ensembl/variation/data/VEP/ \
--cache_version 96 \
--plugin dbNSFP,/nfs/production/panda/ensembl/variation/data/dbNSFP/4.0b1_grch37/dbNSFP4.0b1a_grch37.gz,ALL \
...
#--dir_plugins /homes/anja/bin/VEP_plugins2/ \
#--plugin dbNSFP,/nfs/production/panda/ensembl/variation/data/dbNSFP/4.0b2_grch37/dbNSFP4.0b2a_grch37.txt.gz,ALL \
