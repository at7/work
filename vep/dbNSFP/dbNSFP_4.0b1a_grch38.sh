...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/vep_data/dbnsfp_4.0b1a_grch38.out -e $working_dir/vep_data/dbnsfp_4.0b1a_grch38.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/grch38/4.0b1a_grch38.txt  \
-o $working_dir/vep_data/output/4.0b1a_grch38.txt \
--DB_VERSION 95 \
--cache \
