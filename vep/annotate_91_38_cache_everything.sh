...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/vep_data/human_cache_everything_91_38.out -e $working_dir/vep_data/human_cache_everything_91_38.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/vep_data/input/grch38/chrom13.vcf.gz \
-o $working_dir/vep_data/output/homo_sapiens_chrom13_cache_everything_91_38.txt \
--cache \
