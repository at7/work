...
bsub -q production-rh7 -M 5000 -R "rusage[mem=5000]" -J vep -o $working_dir/dbnsfp_2.9_grch37.out -e $working_dir/dbnsfp_2.9_grch37_12062018.err \
perl $HOME/bin/ensembl-vep/vep \
-i $working_dir/ESP6500-European_American.vcf.gz  \
-o $working_dir/dbnsfp_2.9_grch37.txt \
--port 3337 \
--cache \
--dir_cache /hps/nobackup2/production/ensembl/anja/vep/ \
--dir_plugins /homes/anja/bin/VEP_plugins/ \
--cache_version 92 \
--plugin dbNSFP,/nfs/production/panda/ensembl/variation/data/dbNSFP/2.9.2/dbNSFP2.9.2.txt.gz,SIFT_pred,Polyphen2_HDIV_pred,MutationTaster_pred,GERP++_RS,ESP6500_AA_AF,ESP6500_EA_AF,clinvar_trait \
--force_overwrite \
