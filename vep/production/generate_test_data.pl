...
my $fh = FileHandle->new("/hps/nobackup2/production/ensembl/anja/vep_data/input/grch38/vep_cache_test_chr12.txt", 'w');

my $registry = 'Bio::EnsEMBL::Registry';
my $file = '/hps/nobackup2/production/ensembl/anja/release_96/human/vep_dumps/ensembl.registry';
