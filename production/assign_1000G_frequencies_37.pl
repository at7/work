...
my $vcf_file = '/gpfs/nobackup/ensembl/anja/release_92/grch37/dumps/vcf/homo_sapiens/homo_sapiens.vcf.gz';
my $fh_out = FileHandle->new('/gpfs/nobackup/ensembl/anja/release_92/grch37/dumps/vcf/homo_sapiens/1000GENOMES-phase_3.vcf', 'w');
