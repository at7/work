...
my $vcf_file = "/hps/nobackup2/production/ensembl/anja/release_95/human/grch37/dumps/vcf/homo_sapiens/homo_sapiens-chr$chrom.vcf.gz";


my $fh_out = FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_95/human/grch37/dumps/vcf/homo_sapiens/1000GENOMES-phase_3_chrom$chrom.vcf", 'w');
