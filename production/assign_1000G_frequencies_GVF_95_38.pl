...
#
my $gvf_file = "/hps/nobackup2/production/ensembl/anja/release_95/human/dumps/gvf/homo_sapiens/homo_sapiens-chr$chrom.gvf.gz";
my $fh_in = gzopen($gvf_file, "rb") or die "Error reading $gvf_file: $gzerrno\n";
my $fh_out = FileHandle->new("/hps/nobackup2/production/ensembl/anja/release_95/human/dumps/gvf/homo_sapiens/1000GENOMES-phase_3_chrom$chrom.gvf", 'w');
